...
Es gibt aber natürlich auch eine andere Art, das Programm zu erlangen: Direkt über den frei zugänglichen Quelltext kompilieren und installieren. Hierbei wird unter anderem SCons als Build-Tool verwendet. Dafür sind folgende Schritte notwendig:
...
\end{lstlisting}
Im Repository sind auch die von uns gewünschten Testfälle enthalten. 
